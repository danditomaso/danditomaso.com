...
export default async function ProjectsPage() {
  ...
  //     ...allProjects.value.map((p) => ["pageviews", "projects", p.meta.slug].join(":")),
  //   )
  // ).reduce(
  //   (acc, v, i) => {
  //     acc[allProjects.value.at(i)?.meta?.slug] = v ?? 0;
  //     return acc;
  //   },
            ...
            <Link href={`/projects/${featured?.meta.slug}`}>
              <article className="flex flex-col gap-4 p-4 h-full md:p-8">
                <>
                  ...
                  <TechList techUsed={featured.meta.tech} />
